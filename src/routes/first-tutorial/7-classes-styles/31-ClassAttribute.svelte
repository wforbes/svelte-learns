...
<div class="container">
	...
	>
	// Below is the same as above, saying 'always add the card class, and add the flipped class if its truthy'	
	-->
...
<style>
	:root {
		--bg-1: whitesmoke!important;
		--bg-2: lightgray!important;
		--bg-3: midnightblue!important;
	}
	.container {
		display: flex;
