<script lang="ts">
	...
	import IntroState from './5-IntroState.svelte';
	import DeepState from './6-DeepState.svelte';
	import DerivedState from './7-DerivedState.svelte';
	import InspectingState from './8-InspectingState.svelte';
	import Effects from './9-Effects.svelte';
</script>

<h1>Reactivity</h1>
<p class="text-center">
	Tutorials from the Svelte website. Starting <a href="https://svelte.dev/tutorial/svelte/state">here</a>.
</p>
